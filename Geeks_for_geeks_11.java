//Game with nos// You are given an array arr[], you have to re-construct an array arr[].
...
public class Geeks_for_geeks_11 
{
	public static void main(String[] args) 
	{
		int a[]= {5,9,7,6};
		
		System.out.println(game_with_number(a,a.length));
	}
	
	public static int[] game_with_number(int a[],int n)
	{
		int b[]=new int[n];
